...
pub fn check_collision_with_velocity(
    ...
    let collision = left_a_next < right_b_next
        && right_a_next > left_b_next
        && top_a_next > bottom_b_next
        && bottom_a_next < top_b_next;
...
pub fn get_ray_intersection_fraction(origin: &Vec2, direction: &Vec2) -> f32 {
    let mut t = 0.0;
...
pub fn minkowski_difference(a: &Transform, b: &Transform) -> Transform {
...
pub fn closest_point_on_bounds_to_point(bounds: &Transform, point: &Vec2) -> Vec2 {
